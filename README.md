...
sa4birds/
│
├── additional_data/                        # Auxiliary data 
...
### System Requirements
- **Operating System:** Linux-based system (e.g., Ubuntu 24.04.4 LTS)
...
| Regime | Description                               | Download                                                                                     |
|--------|-------------------------------------------|----------------------------------------------------------------------------------------------|
| **DT** | Dedicated training (task-specific models) | [Link](https://drive.google.com/drive/folders/1V0sY20-FDjGbCmsnZB7MuXKTelN9sqfq?usp=sharing) |
...
After installing the dependencies listed in `requirements.txt` and downloading the checkpoints, you can run the evaluation on BirdSet using `validate_birdset.py`.
...
Follow the instructions in the official [BEANS repository](https://github.com/earthspecies/beans) to download the data.
